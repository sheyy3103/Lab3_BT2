...
var sort_Price = (sort_type:string) => {
    let myData = myDatas();
    if (sort_type == 'ASC') {
        let priceSort = myData.sort(function (a: any, b: any) {
...
var input_min:any = document.getElementById("input_min");
var input_max:any = document.getElementById("input_max");
var btn_price:any = document.getElementById('btn_price');
